  ...
  <body>
    ...
    <div class="container-fluid">
     <div class="alert-success">
        <a href="index.php" class="btn btn-danger text-center">
       Back</a>
     </div>
      <?php
      if(isset($_GET["add"]))
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="report.php?pdf=1&id='.$row["order_id"].'">PDF</a></td>
                <td><a href="invoice.php?update=1&id='.$row["order_id"].'"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                <td><a href="#" id="'.$row["order_id"].'" class="delete"><i class="fa fa-trash" aria-hidden="true" style="color:red;"></i></a></td>
              </tr>
            ';
          }
        }
